...
export default function App() {
  ...
  const handleNext = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://poseidonarc-production.up.railway.app/api/submit-email', {
        method: 'POST',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://poseidonarc-production.up.railway.app/api/submit-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
